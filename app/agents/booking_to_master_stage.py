"""Агент для стадии записи к конкретному мастеру."""
...
BOOKING_TO_MASTER_STAGE_INSTRUCTION = """# РОЛЬ
...
booking_to_master_agent = create_react_agent(
    model=llm,
    tools=[
        book_times_tool,
        find_slots_tool,
    ...
    prompt=BOOKING_TO_MASTER_STAGE_INSTRUCTION,
)
