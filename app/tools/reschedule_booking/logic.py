    ...
    try:
        ...
        if not staff_id or staff_id == 0 or staff_id == 1:
            return {
                "success": False,
                "message": None,
                "error": "Неверный ID мастера. Получите из GetClientRecords - каждая запись содержит staff_id."
            }
        ...
        if not service_id or service_id == 0 or service_id == 1:
            return {
                "success": False,
                "message": None,
                "error": "Неверный ID услуги. Получите из GetClientRecords - каждая запись содержит service_id."
            }
        ...
        if not client_id or client_id == 0 or client_id == 1:
            return {
                "success": False,
                "message": None,
                "error": "Неверный ID клиента. Получите из GetClientRecords - каждая запись содержит client_id."
            }
        ...
        if not seance_length or seance_length <= 0:
            return {
                "success": False,
                "message": None,
                "error": "Не указана длительность сеанса в секундах. Получите из GetClientRecords - каждая запись содержит seance_length."
            }
