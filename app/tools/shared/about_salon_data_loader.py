"""
Сервис для чтения данных о салоне из Google Cloud Storage
"""
import os
import json
...
class AboutSalonDataLoader:
    """Загрузчик данных о салоне из Google Cloud Storage"""
    ...
    def load_data(self) -> Dict:
        """
        Загрузка данных о салоне из Google Cloud Storage
        ...
        file_name = os.getenv('ABOUT_SALON_FILENAME', 'about_salon.json')
