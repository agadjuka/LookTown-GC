"""
Сервис для чтения данных о мастерах из Google Cloud Storage
"""
import os
import json
...
class MastersDataLoader:
    """Загрузчик данных о мастерах из Google Cloud Storage"""
    ...
    def load_data(self) -> Dict:
        """
        Загрузка данных о мастерах из Google Cloud Storage
        ...
        file_name = os.getenv('MASTERS_FILENAME', 'masters.json')
